...
A total of `r N_incomplete` incomplete cases were removed.
`r N_drop3` participants that did not meet the inclusion criteria of having answered the survey in agreement (4 or 5) or disagreement (1 or 2) to any of the questions were also removed from the analysis.
...
<!-- Both this analytical plan and the corresponding analysis report (**SAR-2022-010-GJ-v01**) are therefore not published online and only the title and year of the analysis will be included in the consultant's Portfolio. -->
